...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./ELMOSLM.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S ELMOSLM -X kill
screen -S ELMOSLM ./ELMOSLM
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ELMOSLMTEAM/Files_ELMOSLM/master/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevELMOSLMW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevELMOSLMW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevELMOSLMW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevELMOSLMW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevELMOSLMW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevELMOSLMW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevELMOSLMW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "sourcelegand")
...
local ELMOSLM_Msg = ''  
if msgs < 100 then 
ELMOSLM_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
ELMOSLM_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
ELMOSLM_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
ELMOSLM_Msg = 'متفاعل' 
elseif msgs < 1200 then 
ELMOSLM_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
ELMOSLM_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
ELMOSLM_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
ELMOSLM_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
ELMOSLM_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
ELMOSLM_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ELMOSLM_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ELMOSLM_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
ELMOSLM_Msg = 'رب التفاعل'  
end 
return ELMOSLM_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceELMOSLM(msg,data) -- بداية العمل
if msg then
...
if DevELMOSLMW(msg) then
local bl = ' ❃∫ اهلا عزيزي آلمـطـور\n ❃∫ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ❃∫ تسـتطـيع‌‏ آلتحگم باوامر البوت\n ❃∫ من خلاال الكيبورت خاص بك\n ❃∫ قناة سورس البوت [اضغط هنا](t.me/sourcelegand)'
local keyboard = {
...
if start then 
SourceELMOSLMr = start
else
SourceELMOSLMr = '❃∫ اهلا عزيزي\n ❃∫ انا بوت اسمي '..Namebot..'\n ❃∫ اختصاصي حمايه الجروبات\n ❃∫ من تكرار والسبام والتوجيه والخ…\n ❃∫ لتفعيلي اتبع الاخطوات…↓\n ❃∫ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ❃∫ [قناة سورس البوت](http://t.me/sourcelegand)'
end 
send(msg.chat_id_, msg.id_, SourceELMOSLMr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevELMOSLMW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevELMOSLMW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,ELMOSLM_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevELMOSLMW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevELMOSLMW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevELMOSLMW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevELMOSLMW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevELMOSLMW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevELMOSLMW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevELMOSLMW(msg) then 
...
if text == 'تحديث السورس ❃' and DevELMOSLMW(msg) then 
os.execute('rm -rf ELMOSLM.lua')
os.execute('wget https://raw.githubusercontent.com/ELMOSLMTEAM/ELMOSLM/master/ELMOSLM.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس ليجاند\n ❃∫ الاصدار » { 1.3v}')
dofile('ELMOSLM.lua')  
end
if text == 'الاصدار ❃' and DevELMOSLMW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس ليجاند \n ❃∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and DevELMOSLMW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/BOBBW) \n ❃∫ [قناه السورس](t.me/sourcelegand)')
end
if text == "ضع اسم للبوت ❃" and DevELMOSLMW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevELMOSLMW(msg) then 
...
if text == 'المشتركين ❃' and DevELMOSLMW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات ❃' and DevELMOSLMW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الجروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevELMOSLMW(msg) then
...
if text == ("قائمه العام ❃") and DevELMOSLMW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevELMOSLMW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevELMOSLMW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevELMOSLMW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevELMOSLMW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevELMOSLMW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevELMOSLMW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevELMOSLMW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevELMOSLMW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الجروبات ❃" and DevELMOSLMW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الجروبات الان » { '..#group..' }'..ELMOSLMk..''..ELMOSLM..'\n❃∫  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevELMOSLMW(msg) then
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'sourcelegand')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevELMOSLMW(msg) then
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcelegand')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevELMOSLMW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevELMOSLMW(msg) then
...
local ELMOSLM1_Msg = database:get(bot_id.."ELMOSLM1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ELMOSLM1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sourcelegand')..') \n ❃∫ '..ELMOSLM1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if ELMOSLM_Msg and not Special(msg) then  
local ELMOSLM_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ELMOSLM_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..ELMOSLM_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/sourcelegand)}\n ❃∫ ["..ELMOSLM_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/sourcelegand)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevELMOSLMW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevELMOSLMW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevELMOSLMW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevELMOSLMW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevELMOSLMW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevELMOSLMW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevELMOSLMW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevELMOSLMW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevELMOSLMW(msg) then  
...
database:sadd(bot_id.."ELMOSLM:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."ELMOSLM:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_ELMOSLM = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_ELMOSLM then 
names_ELMOSLM = database:smembers(bot_id.."ELMOSLM:blocname"..msg.chat_id_) or ""
if names_ELMOSLM and names_ELMOSLM[1] then 
for i=1,#names_ELMOSLM do 
if name_ELMOSLM:match("(.*)("..names_ELMOSLM[i]..")(.*)") then 
...
database:set(bot_id.."ELMOSLM:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."ELMOSLM:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."ELMOSLM:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."ELMOSLM:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."ELMOSLM:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_ELMOSLMa_new(ELMOSLM1,ELMOSLM2)
if ELMOSLM2 and ELMOSLM2.first_name_ then 
if ELMOSLM2.first_name_:match("(.*)"..database:get(bot_id.."ELMOSLM:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ELMOSLM:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local ELMOSLM_nnn = database:get(bot_id.."ELMOSLM:nump"..msg.chat_id_) or 5
local ELMOSLM_nnn2 = database:get(bot_id.."ELMOSLM:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(ELMOSLM_nnn2) == tonumber(ELMOSLM_nnn) or tonumber(ELMOSLM_nnn2) > tonumber(ELMOSLM_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ELMOSLM:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..ELMOSLM2.username_.."](https://t.me/"..(ELMOSLM2.username_ or "sourcelegand")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ELMOSLM:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(ELMOSLM_nnn) - tonumber(ELMOSLM_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_ELMOSLMa_new)
end
end
...
local ELMOSLMChengName = database:get(bot_id.."ELMOSLM:Cheng:Name"..data.id_)
if not data.first_name_ then 
if ELMOSLMChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ELMOSLMChengName..']')
database:del(bot_id.."ELMOSLM:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if ELMOSLMChengName ~= data.first_name_ then 
local Text = {
  "اسمك القديم كان حلو",
"لي غيرت اسمك يواد/",
"هذا الحلو غير اسمه 😉",
...
database:set(bot_id.."ELMOSLM:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local ELMOSLMChengUserName = database:get(bot_id.."ELMOSLM:Cheng:UserName"..data.id_)
if not data.username_ then 
if ELMOSLMChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..ELMOSLMChengUserName..']')
database:del(bot_id.."ELMOSLM:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if ELMOSLMChengUserName ~= data.username_ then 
local Text = {
'اوعا الواد الهكر غير اليوزر بتاعو',
"الواد الجامد الي غير اليورز بتاعو/ عاش",
"لي غيرت اليوزر بتاعك",
"منور معرف جديد :  "..data.username_.."",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."ELMOSLM:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local ELMOSLMChengPhoto = database:get(bot_id.."ELMOSLM:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if ELMOSLMChengPhoto then 
send(msg.chat_id_, msg.id_, "الواد ابنلقمر مسح كل صورو😂")
database:del(bot_id.."ELMOSLM:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if ELMOSLMChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."ELMOSLM:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
𝐒𝐎𝐔𝐑𝐂𝐄  𝐄𝐋𝐌𝐎𝐒𝐋𝐌 ✵
⇒⇒⇒⇒⇒⇒⇒⇒⇒⇒
[❀ 𝐃𝐄𝐕¹ ļ ˹𝐋𝐄𝐆𝐀𝐍𝐃 ✵](t.me/Xx_LEGAND_xX)                                  
[❀ 𝐃𝐄𝐕²ļ ˹𝐁𝐋𝐀𝐂𝐊 𝐇𝐎𝐔𝐒𝐄 ✵](t.me/B_l_a_c_k_H_o_u_s_e_1)
[❀ 𝐃𝐄𝐕³ ļ ˹𝐁𝐀𝐓𝐎𝐓 𝐄𝐋𝐆𝐋𝐀𝐁𝐀](t.me/DV_AL4)
[❀ 𝐂𝐇 ļ 𝐄𝐋𝐌𝐎𝐒𝐋𝐌 ✵](t.me/suorslegand)
⇒⇒⇒⇒⇒⇒⇒⇒⇒⇒
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if text == 'رفع نسخه الاحتياطيه' and DevELMOSLMW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sourcelegand')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'sourcelegand')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevELMOSLMW(msg) then    
dofile('ELMOSLM.lua')  
send(msg.chat_id_, msg.id_, ' ❃∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevELMOSLMW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevELMOSLMW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevELMOSLMW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevELMOSLMW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevELMOSLMW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevELMOSLMW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevELMOSLMW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevELMOSLMW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevELMOSLMW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevELMOSLMW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevELMOSLMW(msg) then
...
if text == 'الملفات' and DevELMOSLMW(msg) then
...
if DevELMOSLMW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ELMOSLMTEAM/Files_ELMOSLM/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات ليجاند\n ❃∫ ملفات السورس ↓\n≪━━━━━━MS━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━MS━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس ليجاند ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/sourcelegand) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevELMOSLMW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ELMOSLMTEAM/Files_ELMOSLM/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('ELMOSLM.lua')  
else
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس ليجاند \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevELMOSLMW(msg) then
...
if text == "مسح الملفات" and DevELMOSLMW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ❃∫ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevELMOSLMW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevELMOSLMW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "sourcelegand")
...
function Function_ELMOSLM(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ELMOSLM, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_ELMOSLM, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcelegand')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, ' ❃∫ تم مسح جميع حكاكين')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcelegand')..')'
...
-----------------------------------------------------
if text == 'تنزيل الكفاتس' and Mod(msg) then
database:del(bot_id..'Sakl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ❃∫ تم تنزيل جميع صخوله من الجروب')
end
if text == ("تاك للكفاتس") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n ❃∫ قائمة الكفاتس الجروب \n≪━━━━━━MS━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» كوفتس [@"..username.."]\n"
else
t = t..""..k.."» كوفتس `"..v.."`\n"
end
end
...
---------
if text == ("رفع كوفتس ") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل كوفتس")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
t = "\n ❃∫ قائمة الرقصات الجروب \n≪━━━━━━MS━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» رقاصه [@"..username.."]\n"
else
t = t..""..k.."» رقاصه `"..v.."`\n"
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcelegand')..')'
status  = '\n ❃∫ تم تنزيل رقاصه في الجروب\n ❃∫ خلاص مش عايزك ترقصيلي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
t = "\n ❃∫ قائمة المتوحدين الجروب \n≪━━━━━━MS━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» متوحد [@"..username.."]\n"
else
t = t..""..k.."» متوحد `"..v.."`\n"
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcelegand')..')'
local  statuss  = '\n ❃∫ تم رفع متوحد في اجروب\n ❃∫ ارجع عيش مع البشر ياض'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcelegand')..')'
status  = '\n ❃∫ تم تنزيل الخول من الجروب\n ❃∫ ابسط يا عم مبقتش خول'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcelegand')..')'
local  statuss  = '\n ❃∫ تم رفع خروف في الجروب\n ❃∫ يبني انت خروف دلوقتي قول مااا'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcelegand')..')'
status  = '\n ❃∫ تم تنزيل الخروف من الجروب\n ❃∫ متزعلش يكوكو مبقتش خروف'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:set(bot_id.."ELMOSLM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ELMOSLM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."ELMOSLM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ELMOSLM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ELMOSLM1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ELMOSLM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."ELMOSLM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ELMOSLM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ELMOSLM1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ELMOSLM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."ELMOSLM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ELMOSLM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ELMOSLM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ELMOSLM1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ELMOSLM1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ELMOSLM1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ELMOSLM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ELMOSLM1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ELMOSLM1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━MS━━━━━━≫\n"
for k,v in pairs(list) do  
local ELMOSLM_Msg = database:get(bot_id.."ELMOSLM1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..ELMOSLM_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevELMOSLMW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevELMOSLMW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'sourcelegand')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevELMOSLMW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevELMOSLMW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ليجاند').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ليجاند')
local ELMOSLM_Msg = {
'نعم يا قلبي  '..Namebot..'',
'مش فاضي عايز اي بوشك ده',

}
send(msg.chat_id_, msg.id_,'['..ELMOSLM_Msg[math.random(#ELMOSLM_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevELMOSLMW(msg) then 
...
if text == ("مسح ردود المطور") and DevELMOSLMW(msg) then 
...
if text == ("ردود المطور") and DevELMOSLMW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━MS━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد عام' and DevELMOSLMW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد عام' and DevELMOSLMW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ليجاند').." غادر" or text == 'غادر' then  
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'ليجاند')
send(msg.chat_id_, msg.id_,'اسمي  ['..Namebot..'] يروحي🌝💘')
end
...
if text == 'تفعيل المغادره' and DevELMOSLMW(msg) then   
...
if text == 'تعطيل المغادره' and DevELMOSLMW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ELMOSLM')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcelegand')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_,' ❃∫ انت منشئ الجروب انت هتستهبل 😂🖤') 
return false
end
...
-- vardump(data) 
ELMOSLMdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevELMOSLMW(msg) then
...
*❃م10 ◂ اوامر الاعضاء*
ٴ≪━━━━━━MS━━━━━━≫ٴ
彡 .[ELMOSLM 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/sourcelegand)➢ 
]]
...
zh = https.request('https://rudi-dev.tk/Amir1/ELMOSLM.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━MS━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━MS━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[ELMOSLM 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/sourcelegand)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/ELMOSLM.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/ELMOSLM.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"‏تاريخ ما تنساه ؟","‏كلمة تشعر بالخجل اذا قيلت لك؟","منشن لـ اقرب شخص لك بالتليجرام ؟","كيف تتعامل مع الاشخاص السلبيين ؟","أكثر شيء يُسكِت الطفل برأيك؟","اكثر شي يرضيك اذا زعلت بدون تفكير ؟","ما الشيء الذي يُفارقك؟","مطلبك الوحيد الحين؟","شخص لاترفض له طلبا ؟"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "صراحه" or text == "كت صراحه" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"خد محححح😘💋","عايزني ابوس المعفن ده😏","لا كفايا كد😅😂","مش قدام الناس يوهه"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ليجاند')
...
ELMOSLM = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ELMOSLM)
...
--------------------------------------------------------------------------------------------------------------
SourceELMOSLM(data.message_,data)
...
------------------------------------------------------------------------
local ELMOSLMAbot = database:get(bot_id.."ELMOSLM1:Add:Filter:Rp2"..text..result.chat_id_)   
if ELMOSLMAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..ELMOSLMAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local ELMOSLM1_Msg = database:get(bot_id.."ELMOSLM1:Add:Filter:Rp2"..text..result.chat_id_)   
if ELMOSLM1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..ELMOSLM1_Msg)
